...
public class Mundo : GameWindow
{
    ...
    protected override void OnLoad()
    {
        ...
        _textura2 = Texture.LoadFromFile("Resources/textura.png");
        ...
        _posicaoLuz = new Vector3(0.0f, 1.5f, 0.0f);
